...
package com.yogurt3d.core.managers
{
	...
	import com.yogurt3d.core.plugin.*;
	...
	{
		{
			Kernel.instance.addServer( new Server(SceneTreeManager.SERVERNAME, SceneTreeManager.SERVERVERSION) );
			
			Kernel.instance.loadPluginFromClass( SceneTreePlugins );
		}
		...
		public static function setSceneRootObject(_rootObject:SceneObject, _scene:Scene3D):void
		{
		...
		public static function getSceneLightIndexes(_scene:Scene3D):Vector.<int>
		{
			return s_sceneLightIndexes[_scene];
		}
		
/*		public static function getRenSetIlluminatorLightIndexes(_scene:Scene3D, _renderableChild:SceneObjectRenderable):Vector.<int>
		{
			return s_renSetIlluminatorLightIndexes[ _scene ][_renderableChild];
		}*/
		
		public static function initIntersectedLightByCamera(_scene:Scene3D, _activeCamera:Camera3D):void
		{
		...
		public static function initRenSetIlluminatorLightIndexes(_scene:Scene3D, _renderableChild:SceneObjectRenderable):void
		{
		...
		public static function getIlluminatorLightIndexes(_scene:Scene3D, _renderableChild:SceneObjectRenderable):Vector.<int>
		{
		...
		public static function clearIlluminatorLightIndexes(_scene:Scene3D, _renderableChild:SceneObjectRenderable):void
		{
		...
		public static function getScene(_sceneObject:SceneObject):Scene3D
		{
		...
		public static function getSceneObjectSet(_scene:Scene3D):Vector.<SceneObject>
		{
			return s_sceneObjectsByScene[_scene];
		}
		
		public static function clearSceneFrameData( _scene:Scene3D, _camera:Camera3D ):void{
		...
		public static function getSceneRenderableSet(_scene:Scene3D, _camera:Camera3D):Vector.<SceneObjectRenderable>
		{
		...
		public static function getSceneRenderableSetLight(_scene:Scene3D, _light:Light, _lightIndex:int):Vector.<SceneObjectRenderable>
		{
		...
		public static function getSceneLightSet(_scene:Scene3D):Vector.<Light>
		{
			return s_lightsByScene[_scene];
		}
		
		public static function getSceneCameraSet(_scene:Scene3D):Vector.<Camera3D>
		{
		...
		public static function addChild(_child:SceneObject, _container:SceneObject, index:int = -1):void
		{
			...
			if(s_parentBySceneObjects[_child] != _container)
			{
				...
				if(_scene)
				{
					...
					if(_child is Camera3D)
					{
						addCameraChildIntoSceneSet(Camera3D(_child), _scene);
					}
		...
		public static function _removeChild(_child:SceneObject, _scene:Scene3D):void{
			if(_child is SceneObjectRenderable)
			{
			...
			if(_child is Camera3D)
			{
				removeCameraChildFromSceneSet(Camera3D(_child), _scene);
			}
		...
		private static function removeContainerChildFromSceneSets(_container:SceneObject, _scene:Scene3D):void
		{
		...
		private static function addContainerChildsIntoSceneSets(_container:SceneObject, _scene:Scene3D, index:int = -1):void
		{
		...
		private static function addLightIntoSceneSet(_light:Light, _scene:Scene3D):void
		{
		...
		private static  function addChildIntoSceneSet(_sceneObject:SceneObject, _scene:Scene3D):void
		{
		...
		private static function addRenderableChildIntoSceneSet(_renderableChild:SceneObjectRenderable, _scene:Scene3D,index:int = -1):void
		{
			if( s_sceneTreeManagerByScene[ _scene ] )
			{
		...
		private static function addCameraChildIntoSceneSet(_cameraChild:Camera3D, _scene:Scene3D):void
		{
			var _camerasByScene	:Vector.<Camera3D> = s_cameraObjectsByScene[_scene];
			
			if(!_camerasByScene)
			{
				_camerasByScene					= new Vector.<Camera3D>();
				s_cameraObjectsByScene[_scene]	= _camerasByScene;
			}
			
			_camerasByScene[_camerasByScene.length] = Camera3D(_cameraChild);
		...
		private static  function removeChildFromSceneSet(_sceneObject:SceneObject, _scene:Scene3D):void
		{
			var _sceneObjectsByScene	:Vector.<SceneObject>	= s_sceneObjectsByScene[_scene];
		...
		private static function removeRenderableChildFromSceneSet(_renderableChild:SceneObjectRenderable, _scene:Scene3D):void
		{
			if( s_sceneTreeManagerByScene[ _scene ] )
			{
		...
		private static function removeLightFromSceneSet(_light:Light, _scene:Scene3D):void 
		{
			var _sceneLights		:Vector.<Light>	= s_lightsByScene[_scene];
		...
		private static function removeCameraChildFromSceneSet(_cameraChild:Camera3D, _scene:Scene3D):void
		{
			var _camerasByScene	:Vector.<Camera3D> 	= s_cameraObjectsByScene[_scene];
