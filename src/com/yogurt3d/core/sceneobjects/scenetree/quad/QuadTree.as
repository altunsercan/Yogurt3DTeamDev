...
package com.yogurt3d.core.sceneobjects.scenetree.quad
{
	...
	import com.yogurt3d.core.cameras.frustum.Frustum;
	...
	public class QuadTree
	{
		...
		public function visibilityProcess( camera:Camera3D):void{
			listlength = 0;
			list.length = 0;
		...
		public function visibilityProcessLight( light:Light, lightIndex:int, _scene:Scene3D):void{
			listlength = 0;
			list.length = 0;
		...
		// recursive
		private function _visibilityProcessLight( frustum:Frustum, node:QuadNode, bTestChildren:Boolean, lightIndex:int, _scene:Scene3D) :void
		{		
			var i:int;
