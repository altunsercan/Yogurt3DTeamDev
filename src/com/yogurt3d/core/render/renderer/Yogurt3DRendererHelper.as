...
package com.yogurt3d.core.render.renderer
{
	...
	import com.yogurt3d.core.material.shaders.ShaderParameters;
...
/**
	 ...
	 * 
 	 ...
 	 **/
	public class Yogurt3DRendererHelper
	{
		...
		public function beginScene(_camera:Camera3D=null):void
		{
		 ...
		 * 
		 */		
		public function setProgramConstants(_context3d:Context3D, _params:ShaderParameters, _light:Light=null, _camera:Camera3D=null, _object:SceneObjectRenderable=null, _subMesh:SubMesh = null):Boolean
		{
			...
			for (i = 0; i < _params.fragmentShaderConstants.length; i++) {
				...
				switch(_shaderConstants.type)
				{
					case EShaderConstantsType.TEXTURE:
						var _texture:TextureBase = _shaderConstants.texture.getTextureForDevice(_context3d);
