package com.yogurt3d.presets.effects
{
	...
	public class EffectSwirl extends PostProcessingEffectBase
	{
		...
		{
			super();
			shader.push( m_filter = new FilterSwirl(_radius, _angle, _centerX, _centerY, _effect) );
		}
		...
		public override function render():void{
			trace("\t[EffectSwirl][render] start");
			
			super.render();
			
			trace("\t[EffectSwirl][render] end");
...
internal class FilterSwirl extends Shader
{
