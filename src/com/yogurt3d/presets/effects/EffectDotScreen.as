package com.yogurt3d.presets.effects
{
	...
	{	
		...
		public function EffectDotScreen(_centerX:Number=400, _centerY:Number=300, _angle:Number=1.1, _scale:Number=3.0)
		{
			...
			shader.push( m_filter = new FilterDotScreen(_centerX, _centerY, _angle, _scale) );
		}
		...
		public override function render():void{
			trace("\t[EffectDotScreen][render] start");
			
			super.render();
			
			trace("\t[EffectDotScreen][render] end");
...
internal class FilterDotScreen extends Shader
{
