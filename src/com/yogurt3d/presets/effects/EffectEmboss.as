package com.yogurt3d.presets.effects
{
	...
	public class EffectEmboss extends PostProcessingEffectBase
	{

		public function EffectEmboss()
		{
			super();		
			shader.push(new FilterEmboss());
		}
	
		public override function render():void{
			trace("\t[EffectEmboss][render] start");
			
			super.render();
			
			trace("\t[EffectEmboss][render] end");
...
internal class FilterEmboss extends Shader
{
	...
	public override function setShaderParameters():void{
		...
		var stepH:Number = 1/width;
		
		device.setProgramConstantsFromVector(Context3DProgramType.FRAGMENT, 0,  Vector.<Number>([stepW, stepH, -stepW, -stepH]));
		device.setProgramConstantsFromVector(Context3DProgramType.FRAGMENT, 1,  Vector.<Number>([2.0, -1.0, 1.0, 0.0]));
	}
